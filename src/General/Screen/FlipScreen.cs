...
namespace antiMindblock
{
    public partial class Screen
    {
        public static void Flip(bool inverted)
        {
            ...
            {
                if (inverted)
                    FlipWindowsMonitor(1, Orientations.DEGREES_CW_180);
                else
                    FlipWindowsMonitor(1, Orientations.DEGREES_CW_0);
            }
        ...
        public static bool FlipWindowsMonitor(uint DisplayNumber, Orientations Orientation)
        {
            if(DisplayNumber == 0)
        ...
        public static void ResetAllRotations()
        {
            try
            {
                ...
                while (++i <= 64)
                {
                    FlipWindowsMonitor(i, Orientations.DEGREES_CW_0);
                }
            }
